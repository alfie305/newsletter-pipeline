...
<head>
  ...
  <title>Payload Pipeline — Copy Segments</title>
  <style>
...
<body>
  ...
  <div class="page-header">
    <h1>🛰️ Payload Pipeline — Beehiiv Segments</h1>
    <p>${editionDate}</p>
  </div>
  ...
  <div class="segment" id="seg-1">
    ...
    <div class="segment-content" id="content-1" style="font-family: Helvetica, Arial, sans-serif;">
      ...
      <p><strong>In this week's Payload Pipeline:</strong></p>
      <ul>
${rundownItems}
      </ul>
    </div>
...
${quickHitsHTML}
  ...
  <div class="segment" id="seg-closing">
    ...
    <div class="segment-content" id="content-closing" style="font-family: Helvetica, Arial, sans-serif;">
      ...
      <hr class="divider">
      <p style="font-size:12px; color:#999; text-align:center;">You're receiving this because you subscribed to Payload Pipeline.<br><a href="#" style="color:#999;">Unsubscribe</a> · <a href="#" style="color:#999;">Preferences</a></p>
    </div>
  </div>

  <div class="footer-note">
    Generated by Payload Pipeline Pipeline · Perplexity → Firecrawl → Claude → Nano Banana<br>
